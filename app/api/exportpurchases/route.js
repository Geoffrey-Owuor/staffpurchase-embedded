...
export const GET = requireAuth(
  ...
  SELECT
    ...
    pp.priceCode AS priceBasis, pp.tdPrice AS initialPrice, pp.discountRate, pp.discountedValue,
    pp.tradePrice, pp.retailPrice, pp.onlinePrice, p.Payroll_Approval, p.HR_Approval,
